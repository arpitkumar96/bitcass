...
class WinGo5MinGame extends Command
{

    protected $signature = 'app:win-go5-min-game';

    protected $description = 'This will declare WinGo 5Min Reslut and again start Game.';

    public function handle(){
        $game = Game::whereHas('subCategory',function($query){
            $query->where('name','Win Go');
        })->where('duration',5)->first();
