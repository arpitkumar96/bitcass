...
class WinGo3MinGame extends Command
{

    protected $signature = 'app:win-go3-min-game';

    protected $description = 'This will declare WinGo 3Min Reslut and again start Game.';
