...
class WinGo1MinGame extends Command
{

    protected $signature = 'app:win-go1-min-game';

    protected $description = 'This will declare WinGo 1Min Reslut and again start Game.';

    public function handle(){
        $game = Game::whereHas('subCategory',function($query){
            $query->where('name','Win Go');
        })->where('duration',1)->first();
