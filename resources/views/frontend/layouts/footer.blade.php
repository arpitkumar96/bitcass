<div class="tabbar__container">
    <div class="tabbar__container-item active">
        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56" fill="none" class="">
            <a href="{{route('index')}}">
        ...
        </svg> <a href="{{route('index')}}"><span>Home</span></a>
    </div>
    <div class="tabbar__container-item">
        ...
        <a href="{{route('activity')}}"><span>Task</span></a>
    </div>
    <div class="tabbar__container-item">
        <svg width="140" height="140" viewBox="0 0 140 140" fill="none" xmlns="http://www.w3.org/2000/svg" class="">
        ...
        <a href="{{route('user.promotion')}}"><span>Earn</span></a>
    </div>
    <div class="tabbar__container-item">
        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56" fill="none" class="wallet">
        ...
        <a href="{{route('user.wallet')}}"><span>Fund</span></a>
    </div>
    <div class="tabbar__container-item">
        <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 56 56" fill="none" class="">
            @auth('web')
        ...
        @else
            <a href="{{ route('login') }}"><span>Account</span></a>
        @endauth
    </div>
</div>
