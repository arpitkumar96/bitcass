...
<html lang="en">
    ...
    <body class="ovr-mdl">
        <div class="mainbox mb-3 pb-3 m-2">
            <div class="container">
                <div class="mt-3">
                    <img class="error" src="{{ asset('frontend/assets/images/cancel.png') }}" alt="">
                </div>
                <div class="success-text mt-4">Payment Timeout</div>
                <div class="success-subtext mt-2">The Payment has timed out and is now invalid. Please initiate the payment again.</div>
            </div>
        </div>
    </body>
