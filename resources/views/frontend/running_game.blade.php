...
<div class="row mt-3">
        ...
        <div class="box-1">
            ...
            <div class="Betting__C-foot">
                <div class="Betting__C-foot-b">
                    <a class="cursor-pointer" onclick="getSelectedData('size','big')"> Big </a>
                </div>
                <div class="Betting__C-foot-s">
                    <a class="cursor-pointer" onclick="getSelectedData('size','small')">Small </a>
                </div>
            </div>
    ...
    <div class="col-12 mt-3">
        <ul class="nav nav-pills" role="tablist" style="background: none;justify-content: space-between;">
            <li class="nav-item">
                <a class="nav-link active text-center" onclick="getGameHistory('{{ $game->id }}')">
                    Game history
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link text-center" onclick="getUserGameHistory('{{ $game->id }}')">
                    My history
                </a>
            </li>
        </ul>
            ...
            <div class="col-12">
                <div data-v-28738ead="" class="Trends__C">
                    ...
                    <div class="Trends__C-body2">
                        <div issuenumber="20240409010965" number="8" colour="red"
                            ...
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010965</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas0" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item">3</div>
                                        <div class="Trends__C-body2-Num-item">4</div>
                                        <div class="Trends__C-body2-Num-item">5</div>
                                        <div class="Trends__C-body2-Num-item">6</div>
                                        <div class="Trends__C-body2-Num-item">7</div>
                                        <div class="Trends__C-body2-Num-item action8">8</div>
                                        <div class="Trends__C-body2-Num-item">9</div>
                                        <div class="Trends__C-body2-Num-BS isB">B</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div issuenumber="20240409010964" number="5" colour="green,violet"
                            rowid="1">
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010964</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas1" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item">3</div>
                                        <div class="Trends__C-body2-Num-item">4</div>
                                        <div class="Trends__C-body2-Num-item action5">5</div>
                                        <div class="Trends__C-body2-Num-item">6</div>
                                        <div class="Trends__C-body2-Num-item">7</div>
                                        <div class="Trends__C-body2-Num-item">8</div>
                                        <div class="Trends__C-body2-Num-item">9</div>
                                        <div class="Trends__C-body2-Num-BS isB">B</div>
                                    </div>
                                </div>
                        ...
                        <div issuenumber="20240409010963" number="9" colour="green"
                            rowid="2">
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010963</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas2" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item">3</div>
                                        ...
                                        <div class="Trends__C-body2-Num-item">7</div>
                                        <div class="Trends__C-body2-Num-item">8</div>
                                        <div class="Trends__C-body2-Num-item action9">9</div>
                                        <div class="Trends__C-body2-Num-BS isB">B</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div issuenumber="20240409010962" number="4" colour="red"
                            rowid="3">
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010962</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas3" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item">3</div>
                                        <div class="Trends__C-body2-Num-item action4">4</div>
                                        <div class="Trends__C-body2-Num-item">5</div>
                                        <div class="Trends__C-body2-Num-item">6</div>
                                        <div class="Trends__C-body2-Num-item">7</div>
                                        <div class="Trends__C-body2-Num-item">8</div>
                                        <div class="Trends__C-body2-Num-item">9</div>
                                        <div class="Trends__C-body2-Num-BS">S</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div issuenumber="20240409010961" number="3" colour="green"
                            rowid="4">
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010961</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas4" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item action3">3</div>
                                        <div class="Trends__C-body2-Num-item">4</div>
                                        <div class="Trends__C-body2-Num-item">5</div>
                                        <div class="Trends__C-body2-Num-item">6</div>
                                        <div class="Trends__C-body2-Num-item">7</div>
                        ...
                        <div issuenumber="20240409010960" number="7" colour="green"
                            rowid="5">
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010960</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas5" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item">3</div>
                                        ...
                                        <div class="Trends__C-body2-Num-item">5</div>
                                        <div class="Trends__C-body2-Num-item">6</div>
                                        <div class="Trends__C-body2-Num-item action7">7</div>
                                        <div class="Trends__C-body2-Num-item">8</div>
                                        <div class="Trends__C-body2-Num-item">9</div>
                                        <div class="Trends__C-body2-Num-BS isB">B</div>
                                    </div>
                        ...
                        <div issuenumber="20240409010959" number="7" colour="green"
                            rowid="6">
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010959</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas6" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item">3</div>
                        ...
                        <div issuenumber="20240409010958" number="0" colour="red,violet"
                            rowid="7">
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010958</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas7" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item action0">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item">3</div>
                                        <div class="Trends__C-body2-Num-item">4</div>
                        ...
                        <div issuenumber="20240409010957" number="7" colour="green"
                            rowid="8">
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010957</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas8" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item">3</div>
                        ...
                        <div issuenumber="20240409010956" number="6" colour="red"
                            rowid="9">
                            <div class="van-row">
                                <div class="van-col van-col--8">
                                    <div class="Trends__C-body2-IssueNumber">20240409010956</div>
                                </div>
                                <div class="van-col van-col--16">
                                    <div class="Trends__C-body2-Num"><canvas
                                            canvas="" id="myCanvas9" class="line-canvas"></canvas>
                                        <div class="Trends__C-body2-Num-item">0</div>
                                        <div class="Trends__C-body2-Num-item">1</div>
                                        <div class="Trends__C-body2-Num-item">2</div>
                                        <div class="Trends__C-body2-Num-item">3</div>
                                        <div class="Trends__C-body2-Num-item">4</div>
                                        <div class="Trends__C-body2-Num-item">5</div>
                                        <div class="Trends__C-body2-Num-item action6">6</div>
                                        <div class="Trends__C-body2-Num-item">7</div>
                                        <div class="Trends__C-body2-Num-item">8</div>
                                        <div class="Trends__C-body2-Num-item">9</div>
                                        <div class="Trends__C-body2-Num-BS isB">B</div>
...
<script>
    ...
    var game_timing = "{{$game->duration}}:00";
    var remaining_time = "{{ $remaining_time }}";

    if(remaining_time > game_timing){
        location.reload();
    }
