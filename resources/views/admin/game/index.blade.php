        ...
        @can('game-create')
            <div class="col-6">
                <div class="mt-3 text-right">
                    <x-admin.add-button route="{{route('admin.game.create')}}" text="Add Game"/>
                </div>
            </div>
        @endcan
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-content">
                        <form action="{{route('admin.game.index')}}" id="search_form">
                            <div class="row">
    ...
    @push('js')
        ...
        <script>
            ...
            function fillter(){
                ...
                var route = "{{route('admin.game.index')}}";
            ...
            function getSubCategory(){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#search_subcategory').append('<option value="">Select SubCategory...</option>');
                        $.each(data.sub_categories, function(key, val) {
                            $('#search_subcategory').append("<option value="+val.id+" >"+val.name+"</option>");
                        });
                        fillter();
                    }
                });
