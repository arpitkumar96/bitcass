        ...
        @can('gift-create')
            <div class="col-6">
                <div class="mt-3 text-right">
                    <x-admin.add-button route="{{route('admin.gift.create')}}" text="Add Gift"/>
                </div>
            </div>
        @endcan
    </div>
            ...
            <div class="col-lg-12">
                <div class="ibox ">
                    <div class="ibox-content">
                        <form action="{{route('admin.gift.index')}}" id="search_form">
                            {{-- <div class="row">
    ...
    @push('js')
        ...
        <script>
            ...
            function fillter(){
                ...
                var route = "{{route('admin.gift.index')}}";
